...
(function(window) {
	...
	assert = {
		 ...
		 */
		equal: function(actual, expected, message) { /*jshint eqeqeq:false */
		 ...
		 * @function
		 */
		notEqual: function(actual, expected, message) { /*jshint eqeqeq:false */
			QUnit.push(expected != actual, actual, expected, message);
		},
	...
	QUnit.equiv = (function() {
		...
		function(obj) {
			...
			function useStrictEquality(b, a) { /*jshint eqeqeq:false */
 ...
 */
	QUnit.diff = (function() { /*jshint eqeqeq:false, eqnull:true */
